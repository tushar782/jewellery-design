            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-24">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8 justify-between text-sm">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <ul>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">About Us Special</li>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">Rewards & Recognition</li>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">Legacy</li>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">Care & Maintenance</li>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">Contact</li>
                        </ul>
                    </div>
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <ul>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">FAQs</li>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">Size Guide</li>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">Privacy Policy</li>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">Terms & Conditions</li>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">Discount Offers T & C</li>
                            <li className="mb-2 text-sm hover:text-gray-300 cursor-pointer">Disclaimer</li>
                        </ul>
                    </div>
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <div className="flex max-w-xs mx-auto sm:mx-0">
                            <input
                                ...
                                className="w-full px-3 py-2 text-sm text-gray-700 bg-white rounded-l focus:outline-none"
                            />
                            <button
                                type="button"
                ...
                <div className="mt-6 sm:mt-8 border-t border-white"></div>
